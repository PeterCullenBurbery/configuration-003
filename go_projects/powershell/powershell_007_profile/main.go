...
func main() {
	...
	profile_path := filepath.Join(user_profile, "Documents", "PowerShell", "Microsoft.PowerShell_profile.ps1")
	...
	blob_url := "https://github.com/PeterCullenBurbery/powershell-profile/blob/main/powershell-007-profile/Microsoft.PowerShell_profile.ps1"
	...
	fmt.Printf("✅ PowerShell 7 profile downloaded to: %s\n", profile_path)
}
